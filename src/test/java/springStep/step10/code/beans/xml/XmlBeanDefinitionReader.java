package springStep.step10.code.beans.xml;
...
import springStep.step10.code.beans.AbstractBeanDefinitionReader;
            ...
            if (node instanceof Element) {
				...
				if (value != null && value.length() > 0) {
					...
					if (ref == null || ref.length() == 0) {
						throw new IllegalArgumentException("配置出错: <property> 中的子属性 '"
								+ name + "' 必须有一个确定的值或者引用");
					}
